...
const MovieName = ({url,titleName,rating,description,videoUrl}) => {
  ...
  <button className="MuiButtonBase-root MuiIconButton-root MuiIconButton-colorPrimary MuiIconButton-sizeMedium css-qngigf" tabIndex={0} type="button" aria-label="Toggle description">
    ...
    <span className="MuiTouchRipple-root css-w0pj6f" />
                    ...
                    <div className="MuiCardActions-root MuiCardActions-spacing css-3zukih"><div className="counter-container"><button 
                    ...
                    {0} type="button" aria-label="like movie"><span className="MuiBadge-root css-1rzb3uu">👍<span 
                    className="MuiBadge-anchorOriginTopRightRectangular MuiBadge-overlapRectangular MuiBadge-colorPrimary MuiBadge-badge 
                    MuiBadge-standard MuiBadge-anchorOriginTopRight MuiBadge-invisible css-1wi0wlk">0</span></span><span className="MuiTouchRipple-root 
                    css-w0pj6f" /></button><button className="MuiButtonBase-root MuiIconButton-root MuiIconButton-colorError MuiIconButton-sizeMedium 
                    bt-sz-lg css-wkkrd0" tabIndex={0} type="button" aria-label="dislike movie"><span className="MuiBadge-root css-1rzb3uu">👎<span 
                    className="MuiBadge-anchorOriginTopRightRectangular MuiBadge-overlapRectangular MuiBadge-colorError MuiBadge-badge 
                    MuiBadge-standard MuiBadge-anchorOriginTopRight MuiBadge-invisible css-136xit8">0</span></span><span className="MuiTouchRipple-root 
                    css-w0pj6f" /></button></div> <button className="MuiButtonBase-root MuiIconButton-root MuiIconButton-colorError 
